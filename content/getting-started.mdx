...
export const metaData = {
  ...
  title: "Personal Website", // Update with your site title
  name: "Rushabh Dhoke", // Update with your name
  ogImage: "/opengraph-image.png", // Update with your Open Graph image
  description:
    "Personal Website with all Projects achievements.", // Update with your site description
};
...
export const socialLinks = {
  ...
  linkedin: "https://www.linkedin.com/in/rushabhdhoke23/", // Update with your LinkedIn URL
  email: "mailto:rsd@udel.edu", // Update with your email address
};
```
